...
function MultiInput() {
  ...
  async function fileUploadHandler() {
    ...
    try {
      const response = await fetch("https://any-share-oqhc-qmazwii32-orekis-projects-910cdc8e.vercel.app/api/upload-file", {
        method: "POST",
        body: formData,
      });
  ...
  async function TextUploadHandler() {
    ...
    try {
      const response = await fetch("https://any-share-oqhc-qmazwii32-orekis-projects-910cdc8e.vercel.app/api/upload-text", {
        method: "POST",
        headers: {
